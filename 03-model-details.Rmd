...
on parameters should be of type `varType`^[So far, `varType` is either of type `stan::math::var` or `amt::amtVar` (see header `include/amtVar.hpp`).]. `varType`s could be used more
